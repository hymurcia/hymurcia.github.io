export const translations = {
    // METADATOS Y TÍTULOS
    pageTitle: { es: "Hernán Murcia - Portafolio", en: "Hernán Murcia - Portfolio" },
...
downloadCVEnglish: {
    ...
    aboutContent: { 
        es: "Soy Ingeniero de Sistemas, Full Stack Developer y especialista en redes, cloud y soporte TI. Construyo aplicaciones web y móviles, sistemas escalables, herramientas basadas en Machine Learning y estructuras de software orientadas a eficiencia y rendimiento. Me caracterizo por la capacidad de resolver problemas, dar soporte eficiente, desarrollar soluciones funcionales y mantener sistemas estables y seguros.", 
        en: "I am a Systems Engineer, Full Stack Developer, and specialist in networks, cloud, and IT support. I build web and mobile applications, scalable systems, Machine Learning tools, and software structures focused on efficiency and performance. I am known for my ability to solve problems, provide efficient support, develop functional solutions, and maintain stable and secure systems." 
    },

    // SKILLS SECTION
    skillsTitle: { es: "Habilidades", en: "Skills" },
    skillBackend: { es: "Backend", en: "Backend" },
    skillFrontend: { es: "Frontend", en: "Frontend" },
    skillDatabases: { es: "Bases de Datos", en: "Databases" },
    skillDevOps: { es: "Cloud & DevOps", en: "Cloud & DevOps" },
    skillNetworks: { es: "Redes", en: "Networks" },
    skillMobile: { es: "Móvil & ML", en: "Mobile & ML" },
...
// Exporta las frases para el Typing Effect
export const typingPhrases = {
    es: [
        "Ingeniero de Sistemas", 
        "Full Stack Developer", 
        "Experto en Redes y Cloud", 
        "Solucionador de Problemas"
    ],
    en: [
        "Systems Engineer", 
        "Full Stack Developer", 
        "Network and Cloud Expert", 
        "Problem Solver"
    ]
};
